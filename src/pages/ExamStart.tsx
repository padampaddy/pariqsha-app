  ...
  const exams_exam_question=[
   ...
   
        {
          ...
          "question": {
            ...
            "question": "The pie graphs below show the result of a survey of children's activities. The first graph shows the cultural and leisure activities that boys participate in, whereas the second graph shows the activities in which the girls participate. Write a report describing the information shown in the two pie graphs. Write at least 150 words",
            "solution": "",
            "type_of_question": {
              "id": 5,
              "name": "long_answer"
